...
export default class Icons extends React.Component{
    ...
    renderIconsList = () => {
        const icons = {
            ...
            logo: [ 'ndroid', 'android-o', 'apple', 'apple-o', 'windows', 'windows-o', 'ie', 'chrome', 'github', 'aliwangwang', 'aliwangwang-o', 'dingding', 'dingding-o'],
        ...
        return Object.keys(icons).map(item => icons[item].map((icon, i) =>
                <li key={i}>
